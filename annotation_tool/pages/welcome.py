...
def draw_main_page(callback):
    ...
    we are offering music-related gift vouchers (e.g. for music stores, streaming platforms, online music 
    magazines, etc.) to the 3 participants with the highest overall score. More details on the Leaderboard page.
